...
GUID = '74c5e0fc-3625-464d-b81b-b94df05b2eca'
...
FunctionsToExport = 'Get-MgSecurity', 'Get-MgSecurityAlert', 'Get-MgSecuritySecureScore', 
               'Get-MgSecuritySecureScoreControlProfile', 'New-MgSecurityAlert', 
               'New-MgSecuritySecureScore', 
               'New-MgSecuritySecureScoreControlProfile', 'Remove-MgSecurityAlert', 
               'Remove-MgSecuritySecureScore', 
               'Remove-MgSecuritySecureScoreControlProfile', 'Update-MgSecurity', 
               'Update-MgSecurityAlert', 'Update-MgSecuritySecureScore', 
