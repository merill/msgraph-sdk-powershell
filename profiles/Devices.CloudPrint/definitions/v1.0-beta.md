...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      /print/printerShares/{printerShare-id}/allowedGroups/{group-id}: v1.0-beta
      /print/printerShares/{printerShare-id}/allowedUsers: v1.0-beta
      /print/printerShares/{printerShare-id}/allowedUsers/{user-id}: v1.0-beta
      ...
      /print/shares/{printerShare-id}/allowedGroups/{group-id}: v1.0-beta
      /print/shares/{printerShare-id}/allowedUsers: v1.0-beta
      /print/shares/{printerShare-id}/allowedUsers/{user-id}: v1.0-beta
